"""FIX-D1-VERDICT-BLACKLIST-01 — Serve-time verdict cache gate contract.

Verifies that all 10 _LLM_META_MARKERS from narrative_spec are present in
...
10 rejection cases (one per meta-marker) + 2 pass-through cases.
...
# ── Structural: all 10 markers are in _VERDICT_BLACKLIST ─────────────────────
...
def test_blacklist_marker_count():
    """_VERDICT_BLACKLIST must contain all 10 meta-markers."""
