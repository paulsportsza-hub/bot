...
HANDLED_PREFIXES = {
    "noop", "nav", "menu", "sport", "ai",
    "ob_exp", "ob_sport", "ob_nav", "ob_risk", "ob_bankroll", "ob_notify",
    "ob_fav", "ob_fav_manual", "ob_fav_done", "ob_fav_suggest", "ob_edit", "ob_summary",
    "picks", "bets", "teams", "stats", "affiliate", "story",
    "yg", "hot", "edge", "schedule", "tip", "odds", "results",
