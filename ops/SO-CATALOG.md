...
| #50 | Canonical Card Glow — locked working pattern for `match_detail.html` + `edge_detail.html`; forbidden variant patterns enforced by contract tests | ACTIVE | `bot/ops/CANONICAL-GLOW-SPEC.md` (authoritative) · `bot/ops/TECHNICAL.md` §"Canonical Card Glow" (mirror); contract tests `tests/contracts/test_match_detail_canonical.py` + `tests/contracts/test_edge_detail_canonical.py` | 7 May 2026 (LOCKED) | `CANONICAL-GLOW-SPEC.md` L1 · `ops/SO-CATALOG.md` §SO #50 |
| #51 | Daily Maintenance Control Tower — 7 Cowork morning tasks replace legacy arbiters; P0–P3 severity classification mandatory; Paul receives ONE digest at 08:10 SAST | ACTIVE | `HANDOFFS/mzansiedge_daily_maintenance_control_tower.md` (authoritative) · `bot/ops/CONTROL-TOWER.md` (mirror) | 7 May 2026 (LOCKED) | `CONTROL-TOWER.md` L1 · `ops/SO-CATALOG.md` §SO #51 |
