...
class MultiStepSpawn:
    ...
    async def run(
        ...
        single_line_kickoff = (
            ...
            f"`DIFF=$(git show --stat --patch HEAD); codex --profile xhigh exec --quiet "
            ...
            f"pure-codex use only the inline `codex --profile xhigh exec --quiet` "
            f"pattern above. "
            ...
            f"`codex --profile xhigh exec --quiet \"You are an INDEPENDENT pre-flight reviewer "
